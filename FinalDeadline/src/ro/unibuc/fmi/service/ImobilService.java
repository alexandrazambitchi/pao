...
public class ImobilService {
    ...
    private List<Apartament> listaApartament = new ArrayList<>();
    ...
    public void setListaApartament(List<Apartament> listaApartament) {
        this.listaApartament = listaApartament;
    }
    ...
    public List<Apartament> getListaApartament() {
        return listaApartament;
    }
    ...
    public void afisZone(int zona_cautata){
        ...
        for (Apartament apart : listaApartament)
    ...
    public void cautareBuget(double pretMin, double pretMax){
        System.out.println("Apartamente");
        for (Imobil apart : listaApartament)
